...
public class Ocgcore : ServantWithCardDescription
{
    ...
    public override void preFrameFunction()
    {
        ...
        bool l, r, c, a, s;
        l = Input.GetMouseButton(0);
        r = Input.GetMouseButton(1);
        c = Input.GetKey(KeyCode.C);
        s = Input.GetKey(KeyCode.S);
        a = Input.GetKey(KeyCode.A);
        bool all = (l || a) && !r && !c && !s;
        bool no = (r || s) && !l && !c && !a;
        bool smart = c && !l && !r && !a && !s;
        bool standart = !all && !no && !smart;
        if (all)
        ...
        //{
        //    if (gameInfo.get_condition() != gameInfo.chainCondition.all)
        //        gameInfo.set_condition(gameInfo.chainCondition.all);
        //}
        //else if (!Input.GetMouseButtonDown(0) && Input.GetMouseButtonDown(1))
        //{
        //    if (gameInfo.get_condition() != gameInfo.chainCondition.no)
        //        gameInfo.set_condition(gameInfo.chainCondition.no);
        //}
        //else if (!Input.GetMouseButtonDown(0) && !Input.GetMouseButtonDown(1) || Input.GetMouseButtonDown(0) && Input.GetMouseButtonDown(1))
        //{
        //    gameInfo.set_condition(gameInfo.chainCondition.standard);
        //}
