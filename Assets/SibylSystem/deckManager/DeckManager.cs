...
public class DeckManager : ServantWithCardDescription
{
    ...
    void onCopy()
    {
        ...
        int i = 1;
        while (File.Exists("Assets/essential/deck/" + newnamer + ".ydk"))
        {
           ...
           deck.ISide.Count <= 15
           )
            {
                ...
                if (canSave)
                {
                    ...
                    System.IO.File.WriteAllText("Assets/essential/deck/" + deckInUse + ".ydk", value, System.Text.Encoding.UTF8);
                }
                else
                {
                    string value = "#created by ygopro2\r\n#main\r\n";
    ...
    public override void show()
    {
        ...
        gameObjectDesk.GetComponent<Renderer>().material.mainTexture = Program.GetTextureViaPath("Assets/essential/texture/duel/deckTable.png");
